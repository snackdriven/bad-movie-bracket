    ...
    <div style={{ minHeight:"100vh", position:"relative", zIndex:9999, fontFamily:"'Barlow','Helvetica Neue',sans-serif", color:"#d4ccba" }}>
      ...
      <div style={{ position:"relative", zIndex:1, maxWidth:1200, margin:"0 auto", padding:mob?"16px 16px 32px":"20px 32px 40px" }}>
        ...
        <div style={{ textAlign:"center", marginBottom:mob?20:28 }}>
          ...
          <h1 style={{ fontSize:"clamp(28px,7vw,62px)", fontWeight:400, margin:"0 0 4px", fontFamily:"'Jersey 20',sans-serif", letterSpacing:"0.04em", background:"linear-gradient(135deg,#e04030 0%,#901828 100%)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", animation:"title-flicker 4s ease-in-out infinite" }}>Worst Movie Tournament</h1>
